...
public class DynamoDBMapping {
  ...
  public static final Logger LOG = LoggerFactory
      .getLogger(DynamoDBMapping.class);
  ...
  public static class DynamoDBMappingBuilder {
     ...
     * different items with different attributes. TODO This method is incomplete
     * because the itemNumber might not be present and this would be a problem
     * 
     * @param items
     * @param itemNumber
     * @return
     ...
     * 
     * @param tableName
     *          Table name to determine which key schema to obtain
     * @return
     */
    private boolean verifyKeySchema(String tableName) {
      ...
      if (kSchema == null) {
        LOG.error("No keys defined for '" + tableName
